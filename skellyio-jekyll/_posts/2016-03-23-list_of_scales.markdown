...
There are hundreds of such scales. Inclusion on this list is generally because the scales are sort of neat as a way of thinking about something from daily life[1], and also allow us to peak into the mind of their namesakes.
...
There are some measures names "Scales" which are actually "Scores". Scores a set of judging criteria, each to be evaluated and associated with a numerical value and then added up to give the final score. I don't really tend to count those as true scales, as they're not really linear (as there a numerous different combinations of the values of each criteria), and usually aren't as exciting as Scales. I've included one in here, because it's close to my heart.
...
1. **[Richter Scale](http://en.wikipedia.org/wiki/Richter_Scale)** -- Earthquake magnitude
    ...
    This was the first scale I was aware of as a kid. Mainly because I loved geology. As far as I'm concerned it's the original scale. Extra points for being logarithmic, which basically means that shit gets shakey, fast.
...
3. **Glasgow Scale** -- Actually 2 scales: [Coma](https://en.wikipedia.org/wiki/Glasgow_Coma_Scale) and    [Outcome](https://en.wikipedia.org/wiki/Glasgow_Outcome_Scale)
    ...
    The guys at Glasgow University have two scales named after them. Unfortunately, they're both pretty grim.
...
7. **[Likert](https://en.wikipedia.org/wiki/Likert_scale)** - Self-reporting survey responses
    ...
    It's basically the scale that goes from "Strongly Agree" to "Strongly Disagree". The wikipedia page goes full nerd about it, suggesting "obtaining interval level estimates on a continuum by applying the polytomous Rasch model" and that Likert's name "is among the most mispronounced in [the] field".
...
9. **[Mohs Scale](https://en.wikipedia.org/wiki/Mohs_scale_of_mineral_hardness)** -- Mineral Hardness
    ...
    This scale is kinda cool because firstly, it's made up only of minerals (from Talc to Diamond) and secondly, it's not just like "is this harder than quartz", you actually **use the minerals listed to test**. So you go around with a test kit containing all the minerals on the list (available [here](http://geology.com/store/collections/hardness-kit.shtml) – but "Diamond is not included" 😒) and try scratching the thing your trying to test until it stops scratching back. If only Forbes used this technique on its rich list and took Bill Gates around different Saudi kings until they found one he couldn't buy.

10. **[Kinsey Scale](https://en.wikipedia.org/wiki/Kinsey_scale)** - Sexual response/preference

    So that given that this scale could be fairly summed up as "how gay are you?", it seems like it could have been conceived aid scientifically minded school bullies. Actually, it and the report it was introduced in was a bit of a revolution for the understanding and acceptance of everyone on the sexual spectrum when it was first published in 1948.

    Given then time period, it's no surprise that some of the assessment criteria sound a little stilted: "more than incidentally homosexual".

    Obviously, human sexuality isn't well expressed by the the number 0-6 and the letter X, so this has been superseded by other measures with even cooler names, like [Klein](https://en.wikipedia.org/wiki/Klein_Sexual_Orientation_Grid) and [Storms](https://www.asexuality.org/wiki/index.php?title=Storms%27_model).
...
13. **[Schmidt sting pain index](https://en.wikipedia.org/wiki/Schmidt_sting_pain_index)** - Insect Sting Pain
    ...
    The scale goes from 0 to 4, where a level 0 sting is basically a kiss from a butterfly, a beesting ("the benchmark of sting pain" is level 2) and level 4 stings are so bad that Schmidt only found 4 creatures with that god-given level of cruelty. He described the sting from the Tarantula Hawk as being like “a running hair dryer has just been dropped into your bubble bath.”

    There's a great [Straight Dope](http://www.straightdope.com/columns/read/3052/did-the-creator-of-the-schmidt-sting-pain-index-volunteer-to-get-stung-by-everything-on-earth) article on this one that's worth reading.
...
14. **[Holmes and Rahe stress scale](https://en.wikipedia.org/wiki/Holmes_and_Rahe_stress_scale)** -- Relative Stress of Negative Life Events
    ...
    They rate from the innocuous, a "Change in number of family reunions" which contributes	15 Life Change Units (LCU), through "Trouble with boss" which equals 23 LCU, Marriage (50 LCU), Death of a close family member (53 LCU), Imprisonment (63 LCU), Divorce (73 LCU) all the way up to the most traumatic, the Death of a spouse (100 LCU).

    I feel this scale has real potential for all sorts of one-upmanship: "My Trouble with in-laws (29) and Sexual difficulties (39) trump your Tax Fraud (11) and Losing a leg (53)".
